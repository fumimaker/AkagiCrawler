...
## プロジェクト概要
AkagiCrawler は、アズールレーンの周回操作を自動化する個人開発プロジェクトです。  
iPhone 画面をキャプチャして YOLO でシーンや敵位置を認識し、その結果に応じて XY プロッタへ Gcode を送信してタップ操作を実行します。  
このリポジトリには、認識モデルの学習用コード（keras-yolo3）と、認識結果に基づいて実際に操作するクローラー本体が含まれています。
